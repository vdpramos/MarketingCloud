...
FROM (
    ...
    LEFT JOIN Publico_Apto_Clientes_NeoBpo aptos ON aptos.CPF_CNPJ = B.HC_CPF_CNPJ__C
    LEFT JOIN Publico_Inapto_Clientes_NeoBpo inaptos ON inaptos.CPF_CNPJ = B.HC_CPF_CNPJ__C
    WHERE
