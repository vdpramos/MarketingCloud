SELECT
  ...
  FROM
  TB_BASE_PROSPECT_OTC291_TMKT A /* TB_BASE_OTC291 */
INNER JOIN TB_BASE_PROSPECT_COMOTC_TRATADA_TMKT B ON SUBSTRING(RETORNO, 23, 15) = RIGHT(REPLICATE ('0' , 15)+CONVERT(VARCHAR, B.CPF), 15)