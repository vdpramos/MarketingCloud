...
FROM (
	...
	AND A.ISACTIVE = 1
	/* ID DA CAMPANHA PAI (HEADER) DE BOAS VINDAS POSTALCAP */
	AND A.PARENTID = '7016g000000NVteAAG'
	/* AND A.HC_CAMPANHA_EXECUTADA_NO_MKT__C = 0 */
	AND D.HC_SITUACAO__C = 'ATIVO'
	/* PARCEIRO TCBB PARA OUROCAP */
	AND D.HC_CODIGO_DO_PARCEIRO_NA_ORIGEM__C = 'TCBV'
	AND D.HC_DATA_INICIO_SORTEIO__C BETWEEN A.HC_DATA_INICIAL_DE_COMPRA__C AND A.HC_DATA_FINAL_DE_COMPRA__C
