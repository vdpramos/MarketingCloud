...
FROM (
    ...
    LEFT JOIN Publico_Apto_Ex_Clientes_Algar aptos ON aptos.CPF_CNPJ = B.HC_CPF_CNPJ__C
    LEFT JOIN Publico_Inapto_Ex_Clientes_Algar inaptos ON inaptos.CPF_CNPJ = B.HC_CPF_CNPJ__C
    WHERE
