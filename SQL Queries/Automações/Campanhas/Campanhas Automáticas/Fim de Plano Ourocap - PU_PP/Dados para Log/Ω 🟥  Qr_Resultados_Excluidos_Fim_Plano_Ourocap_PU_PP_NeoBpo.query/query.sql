SELECT
  ...
  END AS RESULTADO
FROM TB_BASE_FIM_PLANO_OUROCAP_PU_PP_OTC291_TRATADA_NEOBPO OTC291
INNER JOIN TB_BASE_FIM_PLANO_OUROCAP_PU_PP_COMOTC_NEOBPO ORIGEM ON ORIGEM.CPF_CNPJ = OTC291.CPF
