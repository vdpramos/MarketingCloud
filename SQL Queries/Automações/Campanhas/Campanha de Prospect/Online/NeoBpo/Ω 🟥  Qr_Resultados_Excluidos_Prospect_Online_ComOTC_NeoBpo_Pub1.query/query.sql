SELECT
  ...
  END AS RESULTADO
FROM TB_BASE_PROSPECT_OTC291_ONLINE_TRATADA_NEOBPO_PUB1 OTC291
INNER JOIN TB_BASE_PROSPECT_COMOTC_ONLINE_TRATADA_NEOBPO_PUB1 ORIGEM ON ORIGEM.cpf = OTC291.CPF
