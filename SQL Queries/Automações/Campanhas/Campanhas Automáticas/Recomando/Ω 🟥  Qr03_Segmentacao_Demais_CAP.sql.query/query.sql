...
WHERE
    ...
    AND HC_Data_Envio_Registro__c is not null
    and 
    (
      camp.HC_Data_inicial_do_periodo_de_queda__c is null
      or HC_Data_Envio_Registro__c >= camp.HC_Data_inicial_do_periodo_de_queda__c
    )
    and
    (
      camp.HC_Data_fim_do_periodo_de_queda__c is null
      or HC_Data_Envio_Registro__c <= camp.HC_Data_fim_do_periodo_de_queda__c
    )
