...
FROM (
	...
	AND A.PARENTID = '7016g000000NUtIAAW'
	...
	AND A.ISACTIVE = 1
	AND CONVERT(CHAR(10), D.HC_DATA_DO_ULTIMO_RESGATE__C, 112) BETWEEN CONVERT(CHAR(10), A.HC_DATA_INICIAL_DO_PERIODO_DE_RESGATE__C, 112) AND CONVERT(CHAR(10), A.HC_DATA_FIM_DO_PERIODO_DE_RESGATE__C, 112)
	...
	AND C.HC_CPF_CNPJ__C IN ('20127456791','02296584829','00239878396','84405457204','04798818984',
                             '42062187300','39573786800','15595528400','09897557970','06640479559',
                             '56792042820','03085899804','26733058820')
) BASE
INNER JOIN
