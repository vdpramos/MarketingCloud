SELECT
  ...
  CASE WHEN LEN(B.TEL_05) = 9 THEN '(' + SUBSTRING(B.DDD_05, 1, 3) + ') ' + 
           SUBSTRING(B.TEL_05, 1, 5) + '-' + 
           SUBSTRING(B.TEL_05, 6, 4)
      ELSE '(' + SUBSTRING(B.DDD_05, 1, 3) + ') ' + 
           SUBSTRING(B.TEL_05, 1, 4) + '-' + 
           SUBSTRING(B.TEL_05, 5, 4) END AS Telefone5,
  A.DT_NASCIMENTO_SF,
  B.QUARENTENA,
...
INNER JOIN Tb_Base_Prospect_ComOTC_Online_Filtrada_AeC B ON B.CPF = A.CPF